...
<div >
 <br>
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  >
   <input class = "search" type="text" name="search" placeholder="Search by Loan_ID, Book Name  or by ISBN or By Borrower's CARD_ID/SSN" id ="search"  />
  ...
  include "connect.php";
    ...
    if((isset($_POST['search']) && $_POST['search'] != NULL) || $_GET['search'] != NULL)
      ...
      //  echo "YOOO";
        ...
        echo "Type ISBN or TITLE or Author's name of the BOOK or SSN || BORROWER's ID  </b>";
    }
    ?>
