...
<div >
 <br>
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  >
   <input class = "search" type="text" name="search" placeholder="Search by Book Name or Author's Name or even by ISBN" id ="search"  />
  ...
  <?php
    if(isset($_POST['search']) && $_POST['search'] != NULL) 
      { 
        ...
        echo "Type ISBN or TITLE or Author's name of the BOOK </b>";
    }
    ?>
